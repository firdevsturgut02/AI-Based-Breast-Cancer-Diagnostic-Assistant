...
Technical Features:
✅ Hardware Utilization Report (GPU/CPU Detecting)
✅ Inference Latency & Throughput (FPS) Scientific Analysis
✅ Keras 3 Custom Object Handling ('Mean', 'Amax')
✅ Clinical Visuals: Normalized Confusion Matrix, ROC, Grad-CAM Heatmaps
✅ Export Destination: results/evaluator/
"""
...
# Trainer tarafından oluşturulan en iyi model yolu
...
if not os.path.exists(MODEL_PATH):
    raise FileNotFoundError(f"❌ Model found at {MODEL_PATH}. Please run trainer.py first.")

print("🔍 Loading model and mapping Keras 3 custom operations...")
# CBAM bloğundaki Mean ve Amax operasyonlarını tanıtıyoruz
...
# =====================================================================
# 5. INFERENCE TIME ANALYSIS (LATENCY & FPS)
# =====================================================================
def measure_performance(model, iterations=100):
    ...
    # Warm-up (İlk GPU tetiklemesi için)
...
# =====================================================================
# 7. PERFORMANCE METRICS (Confusion Matrix & ROC)
# =====================================================================
print("📊 Generating multi-class performance metrics...")
preds = model.predict(test_gen, verbose=1)
y_pred = np.argmax(preds, axis=1)
y_true = test_gen.classes

# 7.1 Confusion Matrix (Ham Veri)
...
plt.title("Multi-Class ROC Performance", fontsize=14, fontweight='bold')
...
def get_gradcam(model, img_array):
    # Mimari içindeki son konvolüsyon katmanını otomatik yakala
...
# Örnek bir görüntü üzerinde klinik açıklanabilirlik testi
...
print(f"🖼️ Grad-CAM visualization saved at: {EVAL_OUT_DIR}/gradcam_explanation.png")

# =====================================================================
# 9. PERFORMANCE REPORT EXPORT (JSON)
# =====================================================================
tech_summary = {
    ...
    "TF_Keras_Version": tf.__version__
}
...
print(f"\n✅ Evaluation complete.")
print(f"📊 Final Results exported to: {EVAL_OUT_DIR}/")
